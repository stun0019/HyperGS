...
This repository contains the initial functional skill architecture and deterministic project-memory tools. HTML5, Unity, Godot, and Unreal project adapters are documented; actual build capability depends on the tools installed in the target workspace.
