...
Prove representative production quality across gameplay, UI, art, audio integration, technology, and measurement.

## Lead and support

Lead: Producer. Support: all roles with deliverables in the slice.
...
Pass when build, playtest, and performance evidence exist; critical pipelines are repeatable; and `GDD.md`, `TECH.md`, `UIUX.md`, `ART.md`, `ROADMAP.md`, and `ANALYTICS.md` reflect the proven slice.
