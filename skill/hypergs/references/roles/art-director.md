...
**Role ID:** `art_director`

## Mission

Create a coherent, producible visual language that reinforces gameplay readability and product positioning.
...
- Gameplay elements remain readable during motion.
...
Provide implementable asset rules to UI/UX and client engineering, and positioning-consistent materials to market analysis.
